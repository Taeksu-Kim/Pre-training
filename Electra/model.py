...
class custom_Electra(nn.Module):
    def __init__(
        self,
        generator,
        discriminator,
        *,
        num_tokens = None, # Vocab size
        discr_dim = -1,
        discr_layer = -1,
        mask_prob = 0.15,
        random_token_prob = 0.,
        ...
        self.replace_prob = 1 - self.mask_prob
    ...
    def forward(
        ...
        return Results(self.gen_loss_weight * mlm_loss + self.disc_loss_weight * disc_loss, mlm_loss, disc_loss, gen_acc, disc_acc, disc_labels, disc_predictions)